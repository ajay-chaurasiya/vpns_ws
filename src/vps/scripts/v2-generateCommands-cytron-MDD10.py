		...
		if (msg.oldX != msg.destX or msg.oldY != msg.destY):
			print ('Moving towards destination.')
		   	...
		   	if (msg.newAngle == 0):
		   		...
		   		if (((yc - yn) >= 0.1) and (xn > xc)):
#		   		   right()
		   		   print ('Right')
		   		elif (((yn - yc) >= 0.1) and (xn > xc)):
#		   		   left()
		   		   print ('Left')
		   		else:
#		   		   forward()
		   		...
		   		if (((yc - yn) >= 0.1) and (xc > xn)):
#		   		   left()
		   		   print ('Left')
		   		elif (((yn - yc) >= 0.1) and (xc > xn)):
#		   		   right()
		   		   print ('Right')
		   		else:
#		   		   forward()
		   		...
		   		if (((xc - xn) >= 0.1) and (yn > yc)):
#		   		   left()
		   		   print ('Left')
		   		elif (((xn - xc) >= 0.1) and (yn > yc)):
#		   		   right()
		   		   print ('Right')
		   		else:
#		   		   forward()
		   		...
		   		if (((xc - xn) >= 0.1) and (yc > yn)):
#		   		   right()
		   		   print ('Right')
		   		elif (((xn - xc) >= 0.1) and (yc > yn)):
#		   		   left()
		   		   print ('Left')
		   		else:
#		   		   forward()
